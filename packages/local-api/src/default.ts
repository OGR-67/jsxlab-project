...
### Code Cell
A code cell serves as a sandbox to test JavaScript scripts. The code is bundled and executed as you type. To visualize a value, simply use the \`show()\` function. JSX should be passed with tags like \`<Component />\` otherwise it will show the reference but not render it on screen.
...
/*[code:WCE0V]*/
// You can even import css libraries
...
/*[code:Oa1Zn]*/
// Variable from previous cell is passed to this one
show(<App />);
